...
namespace API_Wallet.Controllers
{
    public class MonedasController : Controller
    {
        ...
        public MonedasController(Contextdb context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Abreviatura")] Moneda moneda)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Abreviatura")] Moneda moneda)
        {
            if (id != moneda.Id)
            {
                return NotFound();
